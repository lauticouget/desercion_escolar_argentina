...
# Ruta al archivo CSV en la carpeta "preprocessed"
file_path = 'data/preprocessed/preprocessed.csv'
...
if __name__ == '__main__':
    try:
        ...
        output_file_path = os.path.join(
            preprocessed_dir, 'preprocessed_codificacion.csv')
