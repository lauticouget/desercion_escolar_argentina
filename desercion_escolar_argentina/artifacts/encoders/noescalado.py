...
# Tratamiento de columnas binarias: se identifican NaNs y se codifican -999
...
# Aplicar la funcion a columnas numericas
columnas_numericas = ['PONDERA', 'CH06', 'IV2', 'II2',
                      'IX_TOT', 'IX_MEN10', 'ITF', 'CH06_jefx', 'ratio_ocupados']
