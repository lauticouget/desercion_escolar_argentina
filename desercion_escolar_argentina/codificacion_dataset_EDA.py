...
columnas_cat_ordinales = [
    'II8', 'IV6', 'IV7', 'IV9', 'IV10', 'IV11', 'CH08', 'TRIMESTRE', 'CAT_OCUP', 'DECINDR',
...
columnas_numericas = [
    'PONDERA', 'CH06', 'T_VI', 'V2_M', 'IV2', 'II1', 'II2',
    ...
    try:
       ...
       # Obtener la ruta del directorio base del proyecto
        ...
        output_file_path = os.path.join(
            data_dir, 'preprocessed_codificacion_eda.csv')
